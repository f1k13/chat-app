                        ...
                        <div className="flex items-start justify-end">
                          <div className="ml-3 flex h-7 items-center">
                            <button
                              onClick={onClose}
                              type="button"
                              className="rounded-md bg-white text-gray-450 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2"
                            >
                        ...
                        <div className="flex flex-col items-center">
                          ...
                          <div className="flex gap-10 my-8">
                            <div
                              ...
                              className="flex hover:opacity-75 flex-col gap-3 items-center cursor-pointer"
                            >
                            ...
                            <div className="space-y-8 px-4 sm:space-y-6 sm:px-6">
                              ...
                              {!data.isGroup && (
                                <>
                                  <hr />
                                  <div>
                                    <h2 className="text-sm font-medium text-gray-500 sm:w-40 sm:flex-shrink-0">
                                      Joined
                                    </h2>
